            ...
            >
              ...
              <li class="">
                <a href="/backend/page-add-product.html">
                  <i class="las la-minus"></i><span>Tracking</span>
                </a>
              </li>
              <li class="">
                <RouterLink to="/categories-and-tags">
                  <i class="las la-minus"></i><span>Category & Tags</span>
                </RouterLink>
              </li>
              <li class="">
                <a href="/backend/page-add-product.html">
                  <i class="las la-minus"></i><span>Unites</span>
                </a>
              </li>
            </ul>
          </li>
